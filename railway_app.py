...
def _db_init():
    ...
    try:
        ...
        cur.execute("ALTER TABLE bets ADD COLUMN IF NOT EXISTS script_combo TEXT DEFAULT 'NORMAL'")
        cur.execute("ALTER TABLE bets ALTER COLUMN script_combo TYPE TEXT")
